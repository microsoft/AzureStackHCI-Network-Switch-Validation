...
function Invoke-SwitchValidation {
  <#
    ...
    .EXAMPLE
    Invoke-SwitchValidation -ifIndex 15 -vlanIDs "710,711,712" -mtu 9216

    .EXAMPLE
    Invoke-SwitchValidation -ifIndex 15 -vlanIDs "710,711,712" -mtu 9216 -etsMaxClass 8 -etsBWbyPG "0:48,1:0,2:0,3:50,4:0,5:2,6:0,7:0" -pfcMaxClass 8 -pfcPriorityEnabled "0:0,1:0,2:0,3:1,4:0,5:0,6:0,7:0"

    .INPUTS
    $ifIndex: Host interface index based on "Get-NetAdapter". Mandatory.
    $vlanIDs: Vlan list string separate with comma. Default: "710,711,712".
