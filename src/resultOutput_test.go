...
func TestResultAnalysis(t *testing.T) {
	...
	testCases := map[string]test{
		"fail_lldp_subtype3": {
			input:    &INIType{InterfaceName: "eth1", NativeVlanID: 710, AllVlanIDs: []int{710, 711, 712}, MTUSize: 9214, ETSMaxClass: 8, ETSBWbyPG: "0:48,1:0,2:0,3:50,4:0,5:2,6:0,7:0", PFCMaxClass: 8, PFCPriorityEnabled: "0:0,1:0,2:0,3:1,4:0,5:0,6:0,7:0"},
		...
		"success_lldp_subtype3": {
			input:    &INIType{InterfaceName: "eth1", NativeVlanID: 1, AllVlanIDs: []int{1, 710, 711, 712}, MTUSize: 9214, ETSMaxClass: 8, ETSBWbyPG: "0:48,1:0,2:0,3:50,4:0,5:2,6:0,7:0", PFCMaxClass: 8, PFCPriorityEnabled: "0:0,1:0,2:0,3:1,4:0,5:0,6:0,7:0"},
